function [gt,GT_intensities_K] = GT_image(Fluo, Cam, Grid, srf, indsY, K)
    ...
    gt.pos_all = cell2mat(myind2sub([256 256],find(GT_intensities_all(:) > 0)));
    ...
    gt.pos_K = cell2mat(myind2sub([256 256],find(GT_intensities_K(:) > 0)));    
