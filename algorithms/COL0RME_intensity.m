function [col0rme_int, sol_col0rme_int] = COL0RME_intensity(Y_nobound, supp_x, var_noise,opts) 
    ...
    % Grid search
%     range = 0:0.001:1;
%     [f_mu_range, psnr_range] = grid_search(col0rme_int, sol_col0rme_int, range, ynew, PSFfft, D, Mech, is, opts);
end